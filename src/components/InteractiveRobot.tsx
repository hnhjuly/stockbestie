...
const InteractiveRobot = ({ isLookingAtForm = false }: InteractiveRobotProps) => {
  ...
  return (
    <div
      ref={containerRef}
      className="fixed right-[2%] md:right-[8%] lg:right-[22%] top-[58%] md:top-[85%] lg:top-1/3 -translate-y-1/2 w-36 h-44 lg:w-48 lg:h-56 z-20 lg:logo-float cursor-pointer transition-transform duration-1000 ease-in-out"
      style={{
